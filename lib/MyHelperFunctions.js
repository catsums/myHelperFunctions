...
export function ajax(data, url = "", type = "POST", success = function (x) { }, fail = function (x) { }) {
...
export function ajaxGET(url, callback, failback = function (x) { }) {
    ajax("", url, "GET", callback, failback);
}
export function ajaxPOST(data, url, callback, failback = function (x) { }) {
...
export function setHistoryState(urlPath = "", response, state = {}, callback = function () { }) {
    var newState = Object.assign({}, state);
    if (response) {
        newState.html = response.html;
        newState.pageTitle = response.pageTitle;
...
export function pushHistoryState(urlPath = "", response, state = {}, callback = function () { }) {
    var newState = Object.assign({}, state);
    if (response) {
        newState.html = response.html;
        newState.pageTitle = response.pageTitle;
...
export function randomString(length, chars = null) {
    if (!chars)
...
///ARRAYS
export function hardPush(arr, item, compareProps) {
...
export function getClosestPathInCircle(arr, _from, _to, bias = 0) {
